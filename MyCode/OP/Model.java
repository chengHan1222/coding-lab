...
class Model {
	...
	void setYear(int semester) {
		...
		String[] fileList = IO.traverseDirectory(databasePath + "LessonInfo\\");
		
		for (String file: fileList) {
			String[] InputData = IO.InputAll(databasePath + "LessonInfo\\" + file);
		...
		IO.OutputAll(databasePath + "Cache_LessonInfo.txt", strOutput);
	}
