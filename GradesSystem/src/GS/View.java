...
public class View {
	...
	void loginSuccess(String identity) {
		...
		switch (identity) {
			...
			default:
				JOptionPane.showMessageDialog(this.frameLogin, "未知身分的使用者", "Error", JOptionPane.ERROR_MESSAGE);
		}
	}
	...
	private JMenu menuLesson;
	JMenuItem menuItemSearchLesson;
	private JMenu menuManage;
	JMenuItem menuItemManageAccount;
	JMenuItem menuItemManageLesson;
	JMenuItem menuItemSetLessonForStudent;
	...
	private void initHome() {
		...
		menuLesson = new JMenu("課程");
		menuBar.add(menuLesson);
		
		menuItemSearchLesson = new JMenuItem("開課查詢");
		menuLesson.add(menuItemSearchLesson);
		...
		menuItemManageLesson = new JMenuItem("課程管理");
		menuManage.add(menuItemManageLesson);
		
		menuItemSetLessonForStudent = new JMenuItem("更動學生選課");
		menuManage.add(menuItemSetLessonForStudent);
